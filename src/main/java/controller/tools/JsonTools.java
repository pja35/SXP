...
public class JsonTools<Entity> {
     ...
     *
     * @param entity      java entity to transform in json
     * @param containsMap differentiate from former method (true or false will do the same thing)
     * @return
     */
     ...
     *
     * @param json        json String to put into java
     * @param containsMap differentiate from former method
     * @return Entity
     */
    @SuppressWarnings("unchecked")
