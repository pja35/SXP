(function () {
    ...
    module.controller('viewItems', function ($http, $rootScope, $scope, $state, Item, User) {
    ...
    module.controller('addItem', function ($http, $rootScope, $scope, Item, $state, User) {
        isUserConnected($http, $rootScope, $scope, $state, User);
    ...
    module.controller('editItem', function ($http, $rootScope, $scope, $stateParams, Item, $state, User) {
        isUserConnected($http, $rootScope, $scope, $state, User);
    ...
    module.controller('subItem', function ($http, $rootScope, $scope, $stateParams, Item, $state, User) {
        isUserConnected($http, $rootScope, $scope, $state, User);
    ...
    module.controller('viewItem', function ($http, $rootScope, $scope, $stateParams, $state, Item, User) {
        isUserConnected($http, $rootScope, $scope, $state, User);
        $scope.app.configHeader({
            back: true,
            title: 'View item',
            contextButton: 'editItem',
