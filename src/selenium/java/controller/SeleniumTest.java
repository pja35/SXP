...
public class SeleniumTest {
    ...
    public void testLoginPage() {
        ...
        try {
            ...
            e.printStackTrace();
            fail("buttonsubscribe not found");
        }
