...
\`b' some barrel of beer, and \`c' coins from a certain currency.
Finally, say Alice, Bob and Charlie have an iPhone, Android, or whatever
Smart Phone in their pockets. Using Secure eXchange Protocols on their
Smart Phones, they should be able to quickly declare their resources and
